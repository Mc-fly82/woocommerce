...
require 'register_localize.php';
$script_custom = require 'enqueue_scripts.php';
$register_menu = require 'register_menu.php';
require 'short_code.php';
require 'ajax_handle.php';
...
add_filter( 'post_class', 'remove_hentry_function', 40 );
...
add_action( 'wp_enqueue_scripts', 'twentytwelve_scripts_styles', 999);
