...
function twentytwelve_scripts_styles() {
	...
	wp_enqueue_script( 'twentytwelve-navigation', get_template_directory_uri() . '/inc/js/navigation.js', array( 'jquery' ), '20140711', true );
	...
	wp_enqueue_style( 'twentytwelve-ie', get_template_directory_uri() . '/inc/css/ie.css', array( 'twentytwelve-style' ), '20121010' );
 ...
 * Register custom
 */
 require_once 'enqueues_scripts.php';
 require_once 'enqueues_styles.php';
/**
...
function twentytwelve_customize_preview_js() {
	wp_enqueue_script( 'twentytwelve-customizer', get_template_directory_uri() . '/inc/js/theme-customizer.js', array( 'customize-preview' ), '20141120', true );
}
